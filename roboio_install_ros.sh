opkg update
opkg install boost-dev boost-serialization boost libboost-atomic1.57.0 libboost-chrono1.57.0 libboost-date-time1.57.0 libboost-filesystem1.57.0 libboost-graph1.57.0 libboost-iostreams1.57.0 libboost-program-options1.57.0 libboost-regex1.57.0 libboost-signals1.57.0 libboost-system1.57.0 libboost-thread1.57.0 libeigen-dev libpython2 python-core python-dev libcurl4 lz4 libbz2-0 cmake-dev cmake libxml2-dev libxml2 libgnutls-bin libgnutls-dev libgnutls-openssl27 libgnutls28 libgnutlsxx28 nettle-dev nettle libgmp-dev libgmp10 libgmpxx4 libz-dev libz1 git cmake make gcc g++ gcc-symlinks g++-symlinks binutils python-setuptools python-docutils python-pyyaml python-pkgutil python-dateutil python-argparse python-nose python-netifaces libglog0 libyaml-dev python-pip coreutils

pip install catkin_pkg rospkg rosdistro vcstools rosdep wstool rosinstall rosinstall_generator defusedxml
