...
int main(int argc, char** argv)
{
	...
	ros:NodeHandle nh;
	message_filters::Subscriber<sensor_msgs::Imu> imu(nh, "/navx/imu", 1);
	message_filters::Subscriber<nav_msgs::Odometry> odom(nh, "/navx/odom", 1);
	message_filters::Subscriber<navx_publisher::stampedUInt64> time(nh, "/navx/time", 1);
	...
	pub = nh.advertise<localization::LocalizationMessage>("localization_msg", 1);
